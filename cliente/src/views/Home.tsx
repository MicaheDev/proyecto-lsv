...
Our strategy and motivations are discussed in more detail in our Future Flags blog post and our Open Governance Model.
...
All current future flags are documented in the Future Flags Guide to help you stay up-to-date.
...
Because unstable flags are experimental and not guaranteed to stick around, we ship them in SemVer patch releases because they're not new stable/documented APIs. When an unstable flag stabilizes into a Future Flag, that will be released in a SemVer minor release and will be properly documented and added to the Future Flags Guide.
...
The decision flow for a new feature looks something like this:
    ...
    <h1 className="text-green-500 text-2xl">hoka</h1>
  </div>
}